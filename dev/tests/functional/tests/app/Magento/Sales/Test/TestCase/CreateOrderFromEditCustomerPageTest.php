 ...
 * 10. Select Move to Wish GridList action for Products from Test Data.
 * 11. Click Update Items and Quantities button.
 * 12. Perform assertions.
 * 13. Select Add to Order in "Wish GridList" data grid for correspondent Products.
...
class CreateOrderFromEditCustomerPageTest extends Injectable
{
    ...
    public function test(
        ...
        foreach ([$products[0], $products[2]] as $product) {
            $createBlock->getItemsBlock()->selectItemAction($product, 'Move to Wish GridList');
        }
