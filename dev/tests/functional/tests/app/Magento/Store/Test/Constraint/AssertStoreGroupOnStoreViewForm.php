 ...
 * Assert that New Store Group visible on StoreView Grid in Store dropdown
 */
class AssertStoreGroupOnStoreViewForm extends AbstractConstraint
{
    ...
    public function processAssert(StoreIndex $storeIndex, StoreNew $storeNew, StoreGroup $storeGroup)
    {
        ...
        \PHPUnit\Framework\Assert::assertTrue(
            ...
            'Store Group \'' . $storeGroupName . '\' is not present on StoreView Grid in Store dropdown.'
        );
    }
    ...
    {
        return 'Store Group is visible on StoreView Grid in Store dropdown.';
    }
}
