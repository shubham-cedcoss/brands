 ...
 * Assert that Website visible on Store Group Grid in Website dropdown
 */
class AssertWebsiteOnStoreForm extends AbstractConstraint
{
    ...
    public function processAssert(StoreIndex $storeIndex, NewGroupIndex $newGroupIndex, Website $website)
    {
        ...
        \PHPUnit\Framework\Assert::assertTrue(
            ...
            'Website \'' . $websiteName . '\' is not present on Store Group Grid in Website dropdown.'
        );
    }
    ...
    {
        return 'Website is visible on Store Group Grid in Website dropdown.';
    }
}
