...
/**
 * Check that created Catalog New Products GridList widget displayed on frontend on Category Page.
 */
class AssertWidgetCatalogNewProductsList extends AbstractConstraint
{
    ...
    /**
     * Assert that created Catalog New Products GridList widget displayed on frontend on Category Page.
     *
    ...
    public function processAssert(
        ...
        \PHPUnit\Framework\Assert::assertEquals(
            ...
            'There are wrong products or products are absent on Catalog New Products GridList block on Category page.'
        );
    }
    ...
    {
        return "Catalog New Products GridList widget is present on Category page.";
    }
}
