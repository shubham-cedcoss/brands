 ...
 * Assert that success message appears on My Wish GridList page after adding product to wishlist.
 */
class AssertAddProductToWishlistSuccessMessage extends AbstractConstraint
{
     ...
     * Success add message
     */
    const SUCCESS_MESSAGE = "%s has been added to your Wish GridList. Click here to continue shopping.";
    ...
    {
        return 'Success message appears on My Wish GridList page after adding product to Wish GridList.';
    }
}
