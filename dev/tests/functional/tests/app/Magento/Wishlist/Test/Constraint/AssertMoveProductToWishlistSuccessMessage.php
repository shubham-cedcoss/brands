...
class AssertMoveProductToWishlistSuccessMessage extends AbstractConstraint
{
    ...
    /**
     * Assert that success message appears on My Wish GridList page after moving product to wishlist.
     *
    ...
    {
        return 'Success message appears on Checkout Cart page after moving product to Wish GridList.';
    }
}
