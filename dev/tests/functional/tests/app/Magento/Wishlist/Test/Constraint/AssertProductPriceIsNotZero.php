...
class AssertProductPriceIsNotZero extends \Magento\Mtf\Constraint\AbstractConstraint
{
    ...
    public function processAssert(
        ...
        $customerAccountIndex->getAccountMenuBlock()->openMenuItem('My Wish GridList');
        ...
        \PHPUnit\Framework\Assert::assertNotEquals(
            ...
            $product->getName() . ' has zero price on Wish GridList page.'
        );
    }
    ...
    {
        return 'Product price is not zero in default Wish GridList.';
    }
}
