...
class AddressMetadataTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetAttributes()
    {
        ...
        $this->assertEquals(
            $formAttributesMetadata,
            $formAttributesMetadata1,
            'Grid attribute metadata from the same service became different after some getters were called'
        );
        ...
        $this->assertEquals(
            $formAttributesMetadata,
            $formAttributesMetadata2,
            'Grid attribute metadata from two services are different after some getters were called'
        );
    }
