<?php
/**
 * Test for \Magento\Framework\Filesystem\DirectoryForm\Read
 *
...
/**
 * Class ReadTest
 * Test for Magento\Framework\Filesystem\DirectoryForm\Read class
 */
class ReadTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetAbsolutePathOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->getAbsolutePath('../../DirectoryForm/ReadTest.php');
    ...
    public function testGetRelativePathOutside()
    {
        ...
        try {
            $dir->getRelativePath(__DIR__ .'//./..////DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
        ...
        try {
            $dir->getRelativePath('../../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
    ...
    public function testReadOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->read('../../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testSearchOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->search('/*/*.txt', '../../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testIsExistOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->isExist('../../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testIsReadableOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->isReadable('../../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testIsFileOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->isFile('../../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testIsDirectoryOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->isDirectory('../../DirectoryForm');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
            $dir->isDirectory('//./..///../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testOpenFileOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->openFile('../../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testReadFileOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->readFile('../../DirectoryForm/ReadTest.php');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testReadRecursivelyOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('foo');
        try {
            $dir->readRecursively('../../DirectoryForm');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
