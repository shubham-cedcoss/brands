<?php
/**
 * Test for \Magento\Framework\Filesystem\DirectoryForm\Write
 *
...
class WriteTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRenameOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('newDir1', 0777);
        try {
            $dir->renameFile('../../DirectoryForm/ReadTest.php', 'RenamedTest');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
            $dir->renameFile(
                '//./..///../DirectoryForm/ReadTest.php',
                'RenamedTest'
            );
        } catch (ValidatorException $exception) {
            $exceptions++;
    ...
    public function testCopyOutside()
    {
        ...
        try {
            $dir->copyFile('../../DirectoryForm/ReadTest.php', 'CopiedTest');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
        ...
        try {
            $dir->copyFile(
                ...
                '../../DirectoryForm/copied_outside.txt'
            );
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
    ...
    public function testChangePermissionsOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('newDir1', 0777);
        try {
            $dir->changePermissions('../../DirectoryForm', 0777);
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
    ...
    public function testWriteFileOutside()
    {
        ...
        $dir = $this->getDirectoryInstance('newDir1', 0777);
        try {
            $dir->writeFile('../../DirectoryForm/ReadTest.php', 'tst');
        } catch (ValidatorException $exception) {
            $exceptions++;
        }
        try {
