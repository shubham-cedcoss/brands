<?php
/**
 * Test class for \Magento\Sales\Block\Adminhtml\Order\Create\Grid\Account
 *
...
class AccountTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetFormWithCustomer()
    {
        ...
        self::assertEquals(1, $form->getElements()->count(), "Grid has invalid number of fieldsets");
    ...
    /**
     * Creates a mock for Grid object.
     *
     * @return MockObject
     */
