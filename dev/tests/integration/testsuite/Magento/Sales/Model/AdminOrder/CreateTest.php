...
class CreateTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetCustomerWishlist()
    {
        ...
        self::assertInstanceOf(
            ...
            $wishlist,
            'New Wish GridList is expected to be created if existing Customer does not have one yet.'
        );
        self::assertEquals(0, $wishlist->getItemsCount(), 'New Wish GridList must be empty just after creation.');
        ...
        self::assertEquals(
            ...
            'Wish GridList must contain a Product which was added to it earlier.'
        );
        ...
        self::assertSame(
            ...
            'Wish GridList cached in class variable is expected to be returned.'
        );
        self::assertNotSame(
            $updatedWishlist,
            $this->model->getCustomerWishlist(true),
            'New Wish GridList is expected to be created when cache is forced to be refreshed.'
        );
    }
