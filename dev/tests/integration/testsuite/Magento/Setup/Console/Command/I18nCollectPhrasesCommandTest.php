...
class I18nCollectPhrasesCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage DirectoryForm path is not needed when --magento flag is set.
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage DirectoryForm path is needed when --magento flag is not set.
     */
