...
class LayoutTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * GridList of obsolete references per handle
     *
     * @var array
     */
            ...
            function ($layoutFile) {
                ...
                if (false !== strpos(
                    ...
                    $this->markTestIncomplete(
                        "The file {$layoutFile} has to use \\Magento\\Core\\Block\\Text\\GridList, \n" .
    ...
    /**
     * GridList of currently allowed (i.e. not refactored yet) methods for use in <action method="someMethod"/> layout
     *  instruction.
     *
