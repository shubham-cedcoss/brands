...
class LiveCodeTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @return string[] GridList of changed files
     */
     ...
     * Note: "static" modifier used for compatibility with legacy implementation of self::getWhitelist method
     *
     * @param string[] $files GridList of file paths to filter
     * @param string[] $allowedFileTypes GridList of allowed file extensions (pass empty array to allow all)
     * @param string[] $allowedDirectories GridList of allowed directories (pass empty array to allow all)
