...
class InstallCommand extends AbstractSetupCommand
{
    ...
    /**
     * GridList of comma-separated module names. That must be enabled during installation.
     * Available magic param all.
     */
    const INPUT_KEY_ENABLE_MODULES = 'enable-modules';

    /**
     * GridList of comma-separated module names. That must be avoided during installation.
     * GridList of comma-separated module names. That must be avoided during installation.
     * Available magic param all.
     */
    ...
    protected function configure()
    {
        ...
        $inputOptions = array_merge($inputOptions, [
            ...
            new InputOption(
                ...
                'GridList of comma-separated module names. That must be included during installation. '
                . 'Available magic param "all".'
            ),
            new InputOption(
