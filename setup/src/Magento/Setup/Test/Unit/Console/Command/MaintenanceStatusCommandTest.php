    ...
    public function executeDataProvider()
    {
        return [
            [
                ...
                'GridList of exempt IP-addresses: 127.0.0.1 127.0.0.2' . PHP_EOL
            ],
            [
                [true, []],
                'Status: maintenance mode is active' . PHP_EOL . 'GridList of exempt IP-addresses: none' . PHP_EOL
            ],
            [
                [false, []],
                'Status: maintenance mode is not active' . PHP_EOL . 'GridList of exempt IP-addresses: none' . PHP_EOL
            ],
            [
